...
import it.aboutbits.postgresql.core.infrastructure.persistence.tables.records.PgRolesRecord;
...
public class PgRoles extends TableImpl<PgRolesRecord> {
    ...
    public PgRoles where(Condition condition) {
        return new PgRoles(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public PgRoles whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public PgRoles whereNotExists(TableLike<?> select) {
